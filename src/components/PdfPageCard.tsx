  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute top-1.5 right-1.5 z-10 rounded-full bg-black/50 p-1 opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer hover:bg-white/20"
      >
