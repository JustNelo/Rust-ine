...
export function SettingsPanel({ onClose, onResetOnboarding }: SettingsPanelProps) {
  ...
  return (
    <GlassModal>
        <button
          onClick={onClose}
          className="absolute right-4 top-4 z-10 rounded-lg p-1 text-neutral-400 dark:text-neutral-500 hover:text-neutral-900 dark:hover:text-white hover:bg-black/8 dark:hover:bg-white/6 transition-colors duration-200 cursor-pointer"
        >
        ...
        <div className="relative space-y-5">
          ...
          <div className="space-y-2">
            ...
            {workspace ? (
              <div className="rounded-lg border border-black/12 dark:border-white/8 bg-black/5 dark:bg-white/3 px-3 py-2">
                ...
                <div className="flex gap-2 mt-2">
                  <button
                    ...
                    className="rounded-md bg-black/8 dark:bg-white/6 px-2.5 py-1 text-[10px] text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white transition-colors duration-200 cursor-pointer"
                  >
                    {t("settings.change")}
                  </button>
                  <button
              ...
              <button
                onClick={selectWorkspace}
                className="w-full rounded-lg border border-dashed border-black/20 dark:border-white/15 bg-black/5 dark:bg-white/3 px-3 py-3 text-xs text-neutral-500 hover:text-neutral-900 dark:hover:text-white hover:border-black/30 dark:hover:border-white/25 transition-colors duration-200 cursor-pointer"
              >
          ...
          <div className="pt-2 border-t border-black/10 dark:border-white/6">
            <button
              ...
              className="flex items-center gap-2 rounded-lg px-3 py-2 text-xs text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white hover:bg-black/6 dark:hover:bg-white/4 transition-colors duration-200 cursor-pointer"
            >
          ...
          <div className="pt-2 border-t border-black/10 dark:border-white/6 space-y-2">
            <button
              ...
              className="flex items-center gap-2 rounded-lg px-3 py-2 text-xs text-neutral-400 hover:text-neutral-900 dark:hover:text-white hover:bg-black/6 dark:hover:bg-white/4 transition-colors duration-200 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
            >
