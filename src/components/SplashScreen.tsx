    ...
    >
      <div className="flex flex-col items-center gap-5">
        <div className="relative">
          ...
          <img src={appIcon} alt="Rust-ine" className="relative h-20 w-20 animate-[spin_3s_linear_infinite]" />
        </div>
        <div className="text-center">
          <h1 className="text-2xl font-light text-neutral-900 dark:text-white tracking-tight">{t("app.name")}</h1>
          <p className="mt-1 text-xs text-neutral-400 dark:text-neutral-500">{t("app.tagline")}</p>
        </div>
