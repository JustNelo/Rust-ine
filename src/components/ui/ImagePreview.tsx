...
export const ImagePreview = memo(function ImagePreview({ path, className = "", overlay }: ImagePreviewProps) {
  ...
  return (
    <div className={`relative rounded-2xl overflow-hidden border border-black/8 dark:border-white/8 bg-black/2 dark:bg-white/2 backdrop-blur-xl shadow-[0_8px_32px_0_rgba(0,0,0,0.1)] dark:shadow-[0_8px_32px_0_rgba(0,0,0,0.3)] ${className}`}>
